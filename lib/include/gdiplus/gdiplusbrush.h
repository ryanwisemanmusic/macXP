...
/* Ensure `WINGDIPAPI` is available when the real platform headers
	are not included. Some wrapper headers use it in inline stubs; if
	it's undefined make it an empty macro so declarations parse. */
#ifndef WINGDIPAPI
#define WINGDIPAPI
#endif

/* Provide minimal inline `DllExports` stubs used by this header so
	`DllExports::Gdip*` references resolve when only the wrapper headers
	are parsed. These are C++ inline fallbacks (no extern "C") and are
	guarded to avoid redefinition when a real `DllExports` block is
	available from the flat API headers. */
#ifdef __cplusplus
#ifndef __GDIPLUS_DLL_EXPORTS_BRUSH_STUBS
#define __GDIPLUS_DLL_EXPORTS_BRUSH_STUBS
namespace DllExports {
inline GpStatus WINGDIPAPI GdipDeleteBrush(GpBrush*) { return Ok; }
inline GpStatus WINGDIPAPI GdipGetBrushType(GpBrush*, BrushType* bt) { if (bt) *bt = BrushTypeSolidColor; return Ok; }
inline GpStatus WINGDIPAPI GdipCreateHatchBrush(HatchStyle, ARGB, ARGB, GpHatch**) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipCloneBrush(GpBrush*, GpBrush**) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipGetHatchBackgroundColor(GpHatch*, ARGB*) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipGetHatchForegroundColor(GpHatch*, ARGB*) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipGetHatchStyle(GpHatch*, HatchStyle*) { return NotImplemented; }

inline GpStatus WINGDIPAPI GdipCreateLineBrush(const PointF*, const PointF*, ARGB, ARGB, WrapMode, GpLineGradient**) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipCreateLineBrushI(const Point*, const Point*, ARGB, ARGB, WrapMode, GpLineGradient**) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipCreateLineBrushFromRect(const GpRectF*, ARGB, ARGB, LinearGradientMode, GpWrapMode, GpLineGradient**) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipCreateLineBrushFromRectI(const GpRect*, ARGB, ARGB, LinearGradientMode, GpWrapMode, GpLineGradient**) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipCreateLineBrushFromRectWithAngle(const GpRectF*, ARGB, ARGB, REAL, BOOL, GpWrapMode, GpLineGradient**) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipCreateLineBrushFromRectWithAngleI(const GpRect*, ARGB, ARGB, REAL, BOOL, GpWrapMode, GpLineGradient**) { return NotImplemented; }

inline GpStatus WINGDIPAPI GdipCreateSolidFill(ARGB, GpSolidFill**) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipGetSolidFillColor(GpSolidFill*, ARGB*) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipSetSolidFillColor(GpSolidFill*, ARGB) { return NotImplemented; }

inline GpStatus WINGDIPAPI GdipCreateTexture(GpImage*, WrapMode, GpTexture**) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipCreateTexture2(GpImage*, WrapMode, REAL, REAL, REAL, REAL, GpTexture**) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipCreateTexture2I(GpImage*, WrapMode, INT, INT, INT, INT, GpTexture**) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipCreateTextureIA(GpImage*, GpImageAttributes*, REAL, REAL, REAL, REAL, GpTexture**) { return NotImplemented; }
inline GpStatus WINGDIPAPI GdipCreateTextureIAI(GpImage*, GpImageAttributes*, INT, INT, INT, INT, GpTexture**) { return NotImplemented; }

inline void* WINGDIPAPI GdipAlloc(size_t size) { return ::operator new(size, std::nothrow); }
inline void WINGDIPAPI GdipFree(void *mem) { ::operator delete(mem); }
}
#endif
#endif
...
public:
			...
			MatrixOrder order = MatrixOrderPrepend)
	{
		return updateStatus(DllExports::GdipMultiplyLineTransform(
			(GpLineGradient*) nativeBrush,
			matrix ? matrix->nativeMatrix : NULL, (GpMatrixOrder)order));
	}
	...
	Status RotateTranform(REAL angle, MatrixOrder order = MatrixOrderPrepend)
	{
		return updateStatus(DllExports::GdipRotateLineTransform(
			(GpLineGradient*) nativeBrush, angle, (GpMatrixOrder)order));
	}
	Status ScaleTransform(REAL sx, REAL sy,
			MatrixOrder order = MatrixOrderPrepend)
	{
		return updateStatus(DllExports::GdipScaleLineTransform(
			(GpLineGradient*) nativeBrush, sx, sy, (GpMatrixOrder)order));
	}
			...
			MatrixOrder order = MatrixOrderPrepend)
	{
		return updateStatus(DllExports::GdipTranslateLineTransform(
			(GpLineGradient*) nativeBrush, dx, dy, (GpMatrixOrder)order));
	}
...
public:
			...
			MatrixOrder order = MatrixOrderPrepend)
	{
		return updateStatus(DllExports::GdipRotateTextureTransform(
			(GpTexture*) nativeBrush, angle, (GpMatrixOrder)order));
	}
	Status ScaleTransform(REAL sx, REAL sy,
			MatrixOrder order = MatrixOrderPrepend)
	{
		return updateStatus(DllExports::GdipScaleTextureTransform(
			(GpTexture*) nativeBrush, sx, sy, (GpMatrixOrder)order));
	}
	Status SetTransform(const Matrix *matrix)
	{
			...
			MatrixOrder order = MatrixOrderPrepend)
	{
		return updateStatus(DllExports::GdipTranslateTextureTransform(
			(GpTexture*) nativeBrush, dx, dy, (GpMatrixOrder)order));
	}
