...
/* ddraw.h defines IUnknown as void in non-Win32 builds; undo that before
	pulling in COM headers so IUnknown can be declared as an interface type. */
#ifdef IUnknown
#undef IUnknown
#endif
